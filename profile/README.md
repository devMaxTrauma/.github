...
BL™ v1은 devMaxTrauma Inc.에서 개발한 혁신적인 시각 보조 기기로, 주로 시각장애인들을 위한 고급 기술을 탑재하고 있습니다. 이 제품은 OpenCV와 TensorFlow를 활용한 이미지 인식 기능과 FindMy 기능 등 다양한 편의 기능을 제공합니다.

BL™ v1의 소프트웨어는 오픈소스로 제공되며, 누구나 이를 참고하거나 수정할 수 있지만, 다음과 같은 조건이 적용됩니다:

> ### A. 출처 표기
> BL™ v1의 소프트웨어를 사용할 때는 **반드시 devMaxTrauma Inc.와 BL™ v1의 출처**를 명시해야 합니다. 출처가 명시되지 않은 경우, 해당 소프트웨어의 사용 권한을 상실하며, 이에 대한 **소유권을 주장할 수 없습니다**.
>
> ---
>
> ### B. 비상업적 및 윤리적 사용
> BL™ v1의 소프트웨어는 **상업적 목적** 또는 **비윤리적인 목적**으로 사용할 수 없습니다. 상업적으로 사용하고자 할 경우, devMaxTrauma Inc.의 **사전 서면 동의**가 필요합니다.
>
> ---
>
> ### C. 수정된 소프트웨어에 대한 소유권
> BL™ v1의 소프트웨어를 수정하거나 기반으로 새롭게 개발된 소프트웨어는 **동일한 라이선스 조건**을 따라야 하며, 수정된 코드에 대해서도 devMaxTrauma Inc.가 **소유권을 행사할 수 있습니다**.
>
> ---
>
> ### D. 제품 및 소프트웨어의 보증
> BL™ v1은 **제품 보증 정책**에 따라 제공됩니다. 소프트웨어는 **있는 그대로 제공**되며, 사용 중 발생하는 문제에 대해 devMaxTrauma Inc.는 **책임을 지지 않습니다**. 법적 문제, 손해, 또는 기타 불이익은 사용자에게 있습니다.
>
> ---
>
> ### E. 동의
> BL™ v1의 소프트웨어를 사용하는 경우, 위의 모든 조건에 **자동으로 동의**한 것으로 간주됩니다.
